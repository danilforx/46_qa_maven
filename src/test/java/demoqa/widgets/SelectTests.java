...
public class SelectTests extends TestBase {
    ...
    public void multiSelectTest() {
        ...
        assertTrue( new WidgetsPage(app.driver).areColorsSelected(colorsSelect));//проверка наличия выбранных цветов
    }

//    @Test
//    public void multiCarSelectTest() {
//        String[] cars = {"Volvo", "Audi"};
//        new WidgetsPage(driver)
//                .multiCarSelect(cars)
//                .verifyCarsSelected(cars);
//    }
